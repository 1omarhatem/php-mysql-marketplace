            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        ...
                        <a href="index.php" class="primary-btn cart-btn cart-btn-right"><span class=""></span>
                        Update cart
                        </a>
                    </div>
                </div>
                    ...
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            ...
                            <form action="#">
                                ...
                                <button type="submit" class="site-btn">COUPON APPLICATION</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <a href="#" class="primary-btn">Shopping</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                if (result.isConfirmed) {
                    ...
                    xhr.onload = function() {
                        if (xhr.status == 200) {
                            Swal.fire({
                                title: 'Deleted!',
                                text: 'The product has been successfully removed from the cart.',
                                icon: 'success',
